    ...
    switch (name) {
        case 'imoNumber':
            ...
            if (!imoRegex.test(value) || 
                ...
                repeatingDigitsRegex.test(value)) { 
        ...
        case 'inspectionStatus':
            const allowedInspectionStatuses = ['Passed', 'Failed', 'Pending', 'good'];
            if (!allowedInspectionStatuses.includes(value.trim())) {
                error = "Inspection Status must be Passed, Failed, Pending, or good.";
            }
            break;
